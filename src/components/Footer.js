const Footer = () => {
    return(
        ...
        <div className="row">
            ...
            <div className="col">
                <h3> Location</h3>
                <p className="footer-info"> 123 Fake St. Springville Utah
                    <br />
        ...
        <div className="row">
            ...
            <a href="https://www.instagram.com/" className="col"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-instagram" viewBox="0 0 16 16">
            ...
            <a href="#top" className="col"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-arrow-up" viewBox="0 0 16 16">
